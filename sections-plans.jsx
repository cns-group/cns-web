/* sections-plans.jsx — Payment methods strip + Plans (3 tiers × 6 products) */

function PayIcon({ name }) {
  // tiny mark before each pill name — simple monogram in a rounded box, no
  // brand logos (only the wordmark next to it identifies the service)
...
/* Format a number as AR$ 89.000 (es) or AR$ 89,000 (en) */
...
Object.assign(window, { Plans, PayStrip });
