export const COPY = {
  es: {
    ...
    marquee: [
      'Angular · React · Next.js', 'Node.js · TypeScript', 'PostgreSQL · Redis',
    ...
    process: {
      ...
      steps: [
        ...
        { t: 'Puesta en marcha',d: 'Capacitación con tu prodcto en producción. Listo para usar. Después: soporte mensual opcional.', dur: 'Semana 02' },
      ],
    },
    work: {
      eyebrow: '03 — Casos',
      ...
      software: {
        ecommerce: [
          { tier: 'Starter', tag: 'STR', sub: 'Para empezar a vender ya', price: 50000, setup: 25000, feats: [
            ...
            ['', 'Dominio + SSL + hosting incluido'],['Promociones', 'Gestiona tus promos por la web'],['Soporte', 'personalizado'],
          ...
          { tier: 'Grow', tag: 'GRW', sub: 'Para vender en serio', price: 120000, setup: 25000, featured: true, feats: [
            ['', 'Todo lo de Starter, más:'], ['Catálogo:', 'Sin limite de productos'], ['', '2 sucursales, varios locales'],
        ...
        ticket: [
          { tier: 'Starter', tag: 'STR', sub: 'Tu primer evento online', price: 'comisión', priceNum: '4,5%', priceSuffix: 'por ticket vendido', setup: 25000 , feats: [
            ['', 'Sin limite de entradas'], ['', 'Todos los tipos de entrada (general, vip, early, free)'],
            ['Pagos:', 'Mercado Pago + transferencia'], ['', 'QR validable desde celular'],
            ['', 'Reporte de ventas en vivo'],
            ['', 'Reserva y gestion de mesas online'], ['Soporte', 'personaliazdo'],
          ...
          { tier: 'Grow', tag: 'GRW', sub: 'Festivales y eventos medianos', price: 'comisión', priceNum: '5%', priceSuffix: 'por ticket vendido', setup: 25000, featured: true,
             feats: [
            ['', 'Sin limite de entradas'], ['', 'Todos los tipos de entrada (general, vip, early, free)'], ['', 'Múltiples eventos simultáneos'], 
            ...
            ['', 'Reserva y gestion de mesas online, con menu propio'],
            ['Soporte', 'personalizado'],
          ] },
          { tier: 'Pro', tag: 'PRO', sub: 'Productoras y eventos grandes(según facturación)', price: 'comisión', priceNum: '3,5%', priceSuffix: 'o cuota fija mensual', setup: 'a medida', feats: [
            ['', 'Todo lo de Grow, más:'],['', 'Multi-sucursal'],
            ['', 'API + integración con CRMs'],
            ['APP propia', 'para scanner y promociones por usuario por app'],
            ['Soporte', 'dedicado prioritario'],
          ] },
        ],
        gastro: [
          { tier: 'Starter', tag: 'STR', sub: 'Un solo local', price: 25000, setup: 25000, feats: [
            ...
            ['', 'Carta y panel de stock de productos sin limite'],
          ...
          { tier: 'Grow', tag: 'GRW', sub: 'Hasta 3 locales', price: 35000, setup: 25000, featured: true, feats: [
            ...
            ['', 'Panel de pedidos de proovedores'], ['', 'Programa de fidelización'],
            ['Pagos:', 'MP, Transferencia, tarjetas'],
            ['', 'Panel de registro de pagos'],
            ['', 'Panel de promociones'],
            ['Soporte', 'personalizado'],
          ] },
          { tier: 'Pro', tag: 'PRO', sub: 'Sin limite de locales', price: 100000, setup: 'a medida', feats: [
            ['', 'Todo lo de Grow, más:'], ['', 'Sin limite de locales'],
            ['', 'API para integrar tu ERP'],
            ['', 'App móvil del cliente'],
            ['Soporte', 'dedicado prioritario'],
          ] },
        ],
        gym: [
          { tier: 'Starter', tag: 'STR', sub: 'Gym de barrio / estudio', price: 50000, setup: 25000, feats: [
            ['Hasta', '100 socios activos'], ['', '1 sede'],
            ['','Sistema de notificaciones'],
            ['', 'Control de acceso por QR o DNI'],
            ['', 'Gestion de miembros y pagos manuales'],
            ['Soporte', 'personalizado'],
          ], muted: ['Sin pagos online', 'Sin clases personalizadas', 'Sin rutinas y programas de entrenamiento'] },
          { tier: 'Grow', tag: 'GRW', sub: 'Gimnasio establecido', price: 80000, setup: 25000, featured: true, feats: [
            ['', 'Todo lo de Starter, más:'], ['Hasta', '300 socios activos'], ['', 'Hasta 3 sedes'], 
            ['', 'Panel de entrenadores'],
            ['Pagos', 'online Mercado Pago, Transferencia, tarjetas'], ['', 'Gestion de eventos'],
          ...
          { tier: 'Pro', tag: 'PRO', sub: 'Empezá sin costos', price: 'comision',priceNum: '5%', priceSuffix: 'por socio activo', setup: 'a medida', feats: [
            ['', 'Todo lo de Grow, más:'], ['', 'Sin limite de socios'], ['', 'Sin limite de sedes'],
            ['Soporte', 'dedicado prioritario'],
          ] },
        ],
        queue: [
          { tier: 'Starter', tag: 'STR', sub: 'Un profesional', price: 15000, setup: 25000, feats: [
            ['', 'Marca personal'], ['', 'Sin limite de servicios'],
            ...
            ['', 'Panel de administracion de tus cobros y reservas'],
            ['CTA', 'Boton de whatsapp para reservar'],
            ['Soporte', 'personalizado'],
          ] },
          { tier: 'Grow', tag: 'GRW', sub: 'Un equipo', price: 'comision',priceNum: '10.000', priceSuffix: 'por profesional activo /mes', setup: 25000, featured: true, feats: [
            ['', 'Todo lo de Starter, más:'], ['', 'Sin limite de profesionales'],
            ['', 'Configuracion de cursos y capacitaciones'],
            ['Soporte', 'personalizado'],
          ] },
        ],
        landing: [
          ...
          { tier: 'Pro', tag: 'PRO', sub: 'Estudio o agencia grande', price: 50000, setup: '25000', feats: [
            ['', 'Todo lo de Grow, más:'], ['', 'Hasta 5 paginas'],
            ['', 'Multi-idioma (ES/EN/PT)'], ['', 'Galeria de fotos ilimitada'],
             ['Soporte', 'dedicado prioritario'],
          ] },
        ],
      },
    ...
    contact: {
      ...
      form: {
        ...
        types: ['Ecommerce', 'Gastronomía', 'Gimnasios', 'E-ticketera', 'Turneros', 'Landing profesional', 'Otro / consultar'],
      ...
      successBody: 'Te respondemos en menos de 24 horas hábiles desde codigonortesoluciones@gmail.com. Si es urgente, escribinos por WhatsApp.',
      aside: [
        { h: 'Por email', body: <>Escribinos a <a href="mailto:codigonortesoluciones@gmail.com">codigonortesoluciones@gmail.com</a></> },
        { h: 'Por WhatsApp', body: <>De 9 a 19 (Hora Argentina). <a href="https://wa.me/543517648146" target="_blank" rel="noopener noreferrer">+54 351 764-8146</a></> },
      ],
    },
    footer: {
  ...
  en: {
    ...
    contact: {
      ...
      form: {
        ...
        email: 'Email',
        type: 'Project type',
        types: ['Ecommerce', 'Restaurants', 'Gyms', 'E-ticketera', 'Queueing', 'Pro landing', 'Other'],
      ...
      successTitle: 'Got it.',
      successBody: 'We reply within 24 business hours from codigonortesoluciones@gmail.com. If it\'s urgent, message us on WhatsApp.',
      aside: [
        { h: 'By email', body: <>Write to <a href="mailto:codigonortesoluciones@gmail.com">codigonortesoluciones@gmail.com</a></> },
        { h: 'On WhatsApp', body: <>9am–7pm GMT‑3. <a href="https://wa.me/543517648146" target="_blank" rel="noopener noreferrer">+54 351 764-8146</a></> },
      ],
    },
    footer: {
