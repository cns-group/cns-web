export const COPY = {
  es: {
    ...
    hero: {
      ...
      titleD: 'en línea.',
      lead:
        'Construimos sistemas que las pymes del pueblo argentino necesitan de verdad: ecommerce, turneros, gestión de gimnasios y restaurantes, e-ticketera. Para emprendedores, sin promesas raras.',
      footMeta: 'GMT‑3',
      footStatus: 'Operando',
    },
    marquee: [
      'CRM', 'Gastos · Ingresos', 'Automatización · Reportes',
    ...
    faq: {
      ...
      items: [
        ...
        { q: '¿Trabajan solo en el norte?',
          a: 'No, pero conocemos bien la realidad de las pymes del NEA y NOA. Tenemos clientes en varios puntos del pais. Nuestra mision es ayudar a crecer a los emprendedores.' },
  ...
  en: {
    ...
    hero: {
      ...
      titleD: 'online.',
      lead:
        'We build systems that small businesses in northern Argentina actually need: ecommerce, queuing, gym and restaurant management, e-ticketera. No fashion frameworks, no weird promises.',
      footMeta: 'GMT‑3',
    ...
    faq: {
      ...
      items: [
        ...
        { q: 'Do you only work in the north?', a: 'No, but we know NOA business reality well. Clients in Buenos Aires, Mendoza, Córdoba and Asunción. In-person meetings work for the north and a bit beyond.' },
